import { Modal_Conf } from "./modal-conf-evento";
        ...
        <>
            ...
            <div className="p-4 lg:px-10  align-middle mx-auto flex flex-col lg:gap-10 items-center ">
                    <div className="mb-6 flex">      
                        <h1 className="block w-96 self-center text-4xl font-bold">Registrar Evento</h1>
                        <button
                            type="submit"
                    ...
                    <div className="mb-6 flex">
                    <label className="block w-96 self-center text-lg ">
                    </label>
                    <input
                        type="text"
                        className="shadow-sm input border-2  border-gray-500 text-gray-900 text-sm rounded-lg block w-full p-2.5"
