    ...
    <>
      {modalVisible && (
        <div
          ...
          role="dialog"
        >
          <div className=" relative border-l border-r border-b-4 border-[#618C03] bg-white rounded-lg py-5 px-32 w-3/6 h-3/4">
            ...
            <form className="mt-8">
              <div className="register-order-group">
                ...
                <input type="text" className="register-order-input w-96 h-9" />
              </div>
              <div className="register-order-group">
              ...
              <div className="register-order-group">
                <label className="register-order-label">Fecha de Recojo:</label>
                <input type="date" className="register-order-input w-96 h-9" />
              </div>
