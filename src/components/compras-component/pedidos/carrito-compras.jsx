...
export const CarritoCompras = () => {
  ...
  const actualizarCarrito = (codigo_producto, cant) => {
    const nuevoCarrito = carrito.map((p) =>
      p.codigo === codigo_producto ? { ...p, cantidad: cant } : p
    );
  ...
  const calcularTotal = () => {
    ...
    carrito.forEach((item) =>
      item.visible ? (total += item.cantidad * item.precio) : (total += 0)
    );
    return total;
  };
  ...
  const cambiarVisibilidadProducto = (codigo) => {
    const nuevoCarrito = carrito.map((p) =>
  ...
  return (
    <>
      ...
      >
          ...
          <div className="items">
            {carrito.map((item) => {
              return (
                item.visible && (
                  <>
                    <div className="item-carrito p-5">
                      ...
                      <div className="flex flex-col justify-around h-[70%] self-center">
                        ...
                        <div className="flex flex-row justify-between">
                          ...
                          <div className="flex font-mono font-semibold bg-[#97BF04] rounded-[1.2rem] justify-between items-center flex-row w-[40%] text-white text-xl px-3 h-8">
                            <button
                              onClick={(e) =>
                                decrement(item.codigo, item.cantidad)
                              }
                            >
                              {" "}
                              -{" "}
                            ...
                            <button
                              onClick={(e) =>
                                increment(item.codigo, item.cantidad)
                              }
                            >
                              {" "}
                              +{" "}
                      ...
                      <div className="flex flex-col justify-around items-center ">
                        <div className="text-2xl">
                          ...
                          <span
                            ...
                            onClick={(e) =>
                              cambiarVisibilidadProducto(item.codigo)
                            }
                          >
                            Mover para Después
                          </span>
        ...
        <h1 className="font-bold text-4xl text-center md:text-left text-[#022601] mt-6">
        ...
        arregloVideos={[
          {
            ...
            url: "https://www.youtube.com/embed/znM7vfSrGVE",
          },
        ]}
      />
    </>
