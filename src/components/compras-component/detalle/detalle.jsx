...
export const DetallePedido = () => {
    ...
    return <>
                            ...
                            <div className="w-full text-2xl font-semibold">
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="flex justify-end">
                                        <button type="submit" className="font-medium text-xl p-2 px-8 rounded-md  hover:text-green-900 text-white bg-[#97BF04] mt-5 mb-8" onClick={e => setModalActualizarPedido(true)}>
                                            Editar
                                        </button>
                                    </div>
        ...
        <ModalActualizarPedido modalVisible={modalActualizarPedido} setModalVisible={setModalActualizarPedido} />
    </>
}